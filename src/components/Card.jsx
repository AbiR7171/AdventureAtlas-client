...
const Card = ({ tour, refetch }) => {
  ...
  const { tourName, price, startDate, endDate, members, _id } = tour;
    ...
    <Link to={`/main/single-tour/${_id}`}>
      <div className="main-font md:w-[300px] mx-auto space-y-8  my-20 relative p-8 bg-gray-100 shadow-xl  rounded-md">
        ...
        <div className="space-y-4">
          <p className="capitalize text-black">most popular</p>
          ...
          <div className="pt-4 flex items-center gap-2 ">
            <Link to={`/main/single-tour/${_id}`}>
              <button className="bg-black text-white p-2 px-6 flex items-center gap-2">
                View{" "}
